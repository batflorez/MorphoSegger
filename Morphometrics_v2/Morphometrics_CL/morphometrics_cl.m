...
function morphometrics_cl(stackname,paramname,varargin)
%Tristan Ursell, 2014.
%Modified by Andres Florez 04/20/20
...
%
%Example: morphometrics_cl('mask.tif','Morphometrics_prefs_mask_CL.mat',[],1)
%with meshing -  Andres Florez 04/20/20
...
%threshold segmentation [X0,Y0,Wid,Hgt]
...
%%     SEGMENTATION
    ...
    %It also segments the images based on binary masks from Supersegger
    ...
    image_save(Iseg_out,[basename '_Gparent.tif']) %% what is this
    image_save(Imag_out,[basename '_Gsegt.tif']) % what is this
